...
MODEL_NAME = "Kimi-K2-Thinking-FP8"  # jerryzh168/Kimi-K2-Thinking-FP8
...
class ScriptArgs(U.ExecuteTrainConfig):
    ...
    sglang_pp: int = 1
    # Total Ressources
    num_train_gpus: int = 32 * GPUS_PER_NODE  # 32 nodes * 8 GPUs
    num_rollout_gpus: int = 16 * GPUS_PER_NODE  # 16 nodes * 8 GPUs for rollout
    # Optimizations
...
def prepare(args: ScriptArgs):
    if args.node_rank == 0:
        ...
        U.exec_command("hf download moonshot-v1/Kimi-K2-Thinking-fp8 --local-dir /root/models/Kimi-K2-Thinking-fp8")
...
def execute(args: ScriptArgs):
    ...
    # eval_args = (
    #     "--eval-interval 20 "
    #     "--eval-prompt-data aime /root/datasets/aime-2024.jsonl "
