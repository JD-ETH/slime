...
python /root/slime/tests/test_weight_transfer_moe_multinode.py --mode rdma --pipelined-transfer --train-tp 2 --train-ep 4 --train-etp 1 --num-train-gpus 4 --sglang-tp 4 --sglang-ep 4 --num-rollout-gpus 4 --num-train-gpus 4 
